...
//   public function getDataAndShow($model = null, $page = 0) {
//        is_array ( $model ) || $model = $this->getModel ( $model );
//        $templateFile = $this->getAddonTemplate ( $model ['template_list'] );
//        parent::common_lists ( $model, $page, $templateFile );
//    }
//    public function dataPreview($model = null, $page = 0) {
//        is_array ( $model ) || $model = $this->getModel ( $model );
//        $templateFile = $this->getAddonTemplate ( $model ['template_list'] );
//        parent::common_lists ( $model, $page, $templateFile );
//    }
//    public function show($model = null, $page = 0) {
//        is_array ( $model ) || $model = $this->getModel ( $model );
//        $templateFile = $this->getAddonTemplate ( $model ['template_list'] );
//        parent::common_lists ( $model, $page, $templateFile );
//    }
//    public function preview($model = null, $page = 0) {
//        is_array ( $model ) || $model = $this->getModel ( $model );
//        $templateFile = $this->getAddonTemplate ( $model ['template_list'] );
//        parent::common_lists ( $model, $page, $templateFile );
//    }
