...
$(function(){
	...
	$(".fs_submitBtn").click(function(){
        var forms_id=<?php echo I('get.forms_id');?>;
//        $.get("/weiphp/index.php?s=/addon/Forms/FormsValue/get_forms_data",{"forms_id":forms_id},"")//获取forms_id
		
		var jsonuserinfo = $('#f_form').serialize();
    ;


			alert(jsonuserinfo+forms_id);
        ...
        $.ajax({
			...
			dataType: 'json',
			data: jsonuserinfo+"&forms_id="+forms_id,
			success:function(){
				alert();
			}
		});
